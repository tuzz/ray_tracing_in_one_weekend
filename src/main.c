...
int main(void) {
  ...
  Point3 viewport_mid_mid = vec3_subtract(camera_center, (Vec3){ .z = focal_length });
  Point3 viewport_mid_left = vec3_subtract(viewport_mid_mid, vec3_scale(viewport_u, 0.5f));
  Point3 viewport_top_left = vec3_subtract(viewport_mid_left, vec3_scale(viewport_v, 0.5f));
